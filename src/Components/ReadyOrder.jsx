...
const ReadyOrder = () => {
  return (
    <div className=" m-auto w-max readyorder flex ">
      ...
      <div className="  flex gap-3 flex-col justify-center items-center px-12 py-12 rounded-3xl">
        <h3 className="text-[#ff5f2e] text-4xl font-[800]">Ready to Order ?</h3>
        <p className="">
          Create your account and get your first delivery free!
        </p>
        <button className="bg-[#ff5f2e] text-white px-6 py-3 rounded-xl text-lg ">
