        ...
        <div className="flex flex-1 flex-col gap-5 ">
          {cartItems.length === 0 ? (
            ...
            cartItems.map((item, index) => (
              <div
              key={`${item.pizzaName}-${item.size}-${item.crust}-${item.toppings}`}
                className=" gap-4 text-white  bg-[#ffffff0f] rounded-3xl flex items-center justify-between px-6 py-4  flex-col lg:flex-row md:flex-row"
              >
